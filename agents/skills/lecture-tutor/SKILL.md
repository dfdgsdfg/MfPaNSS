...
- As you teach, surface the matching **YouTube link** (the video notes' `▶ MM:SS` section links / `INDEX.md`) so the learner can watch that lecture moment; use only real links from the notes.
